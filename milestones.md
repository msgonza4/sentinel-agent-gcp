# Project Milestones: The Sentinel Agent
...
- [ ] Migrate API credentials to Secret Manager
- [ ] Configure Service Accounts (IAM) for cross-service communication

## [April 20 - May 1] Phase 4: Observability
- [ ] Implement structured Cloud Logging
- [ ] Create Cloud Monitoring health dashboards
- [ ] Final project presentation and code audit
